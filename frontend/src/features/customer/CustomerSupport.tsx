...
export default function CustomerSupport() {
  ...
  return (
    <>
      <Navbar />
      <main className="max-w-2xl mx-auto px-4 py-10 min-h-[70vh]">
        <div className="mb-6">
          <h1 className="text-2xl font-black">Contact Admin</h1>
          <p className="text-sm text-muted-foreground mt-1">Send a message to our support team.</p>
        </div>
          ...
          <div className="space-y-3">
            ...
            {isLoading ? (
              ...
              <div className="bg-card border rounded-2xl p-10 text-center text-muted-foreground">
                ...
                <p className="text-xs mt-1">Use the button above to contact admin.</p>
              </div>
            ) : (
              reports.map((r: any) => {
